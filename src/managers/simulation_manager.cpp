...
void SimulationManager::generateGalaxy()
{
    auto& Messages = Reg_.ctx<MessageHandler>();
    ...
    for (auto r = DensityWaveLength; r < GalaxyInnerRadius; r += DensityWaveLength*(0.2+1.0*r/GalaxyInnerRadius))
    {
    ...
    for (auto r = GalaxyInnerRadius; r<GalaxyOuterRadius; r += DensityWaveLength)
    {
